			...
			switch ($modo) {
				...
				case 'T.S.U':
					...
					if(  mysqli_num_rows($solvencia) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=T.S.U&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
							header("location: ../capaSuperior/consultarGfolio.php?modo=T.S.U&tipo=http://localhost/Siageg/capaSuperior/cde.php");
						}
				...
				case 'INGENIEROS':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=INGENIEROS&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
							header("location: ../capaSuperior/consultarGfolio.php?modo=INGENIEROS&tipo=http://localhost/Siageg/capaSuperior/cde.php");
						}
				...
				case 'LICENCIADOS':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=LICENCIADOS&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'I.U.B':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=I.U.Btipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'UPTBAL':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=UPTBAL&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'MISIÓN':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=MISIÓN&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Ing. Agroalimentaria':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Ing. Agroalimentaria&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Lic. Administración':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Lic. Administración&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Ing. Construcción Civil':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Ing. Construcción Civil&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Ing. Informática':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Ing. Informática&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Lic. Turismo':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Lic. Turismo&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'TSU. Administración':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=TSU. Administración&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'TSU. Agroalimentaria':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=TSU. Agroalimentaria&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'TSU. Construcción Civil':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=TSU. Construcción Civil&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'TSU. Informática':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=TSU. Informática&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'TSU. Turismo':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=TSU. Turismo&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Hombres':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Hombres&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'TSU(M)':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=TSU(M)&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Mujeres':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Mujeres&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Ingenieras':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Ingenieras&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Licenciadas':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Licenciadas&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'TSU(F)':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=TSU(F)&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'POR CEDULA':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
							...
							$_SESSION['ci'] = $c;
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=POR CEDULA&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'Secretaría':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=Secretaría&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
				...
				case 'solemne':
					...
					if(mysqli_num_rows($resultado) > 0 ){	
						...
						if($tipo == 'secretaria'){
							header("location: ../capaSuperior/consultarGfolio.php?modo=solemne&tipo=http://localhost/Siageg/capaSuperior/sesionSec.php");
						}else{
