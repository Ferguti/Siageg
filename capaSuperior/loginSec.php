...
<html lang="es">  
	...
	<head>
		<title>Inicio de sesión Secretaría</title>			
		<meta charset="UTF-8">
						...
						<div class="container">
							<div class="row">
								<div class="col-xs  center-xs">
									<h4>INICIO DE SESIÓN SECRETARÍA</h4>
					...
					<div class="container">
						<div class="row center-xs">
							<div class="articulos col-xs">
								<article>																		
									<form name="formulario" action="../capaIntermedia/login.php?modo=secretaria" method="POST">	
										<div class="secretaria">
											<label><span class="icon-briefcase"></span> SECRETARÍA GENERAL<span class="icon-briefcase"></label>	
										</div>							
										...
										<nav class="bt-salir">
											<ul>
												<li><a href="http://localhost/Siageg/capaSuperior/regPer.php"><span class="color2"><i class="icon icon-archive"></i></span>Registrarme</a></li>
											</ul>
										</nav>
										<input type="hidden" id="secretaria" name="secretaria" VALUE="1">
									</form>																	
								</article>
							</div>
						</div>
