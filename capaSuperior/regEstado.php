...
<body>
	...
	<?php 
		...
		$db = new conexion();
		$resultado = $db->consultar($db,"SELECT * FROM estados ORDER BY  estado ASC;");
	...
	<div class="contenedor">
		...
		<section class="main">
			<div class="logo">
						...
						<div class="container">
							<div class="row center-xs">
								<div class="articulos col-xs">
									<article>	
									<form name="formulario" action="../capaIntermedia/registro.php?modo=estado" method="POST">
									<input type="text" name="estado" id="estado" placeholder="Nombre del estado" maxlength="25" title="Campo Nombre del estado">																			
									<input type="hidden" name="estados" value="1">
					...
					<div class="tabla">
						<label>Estados registrados</label>
				<table>														
						<tr class = "centro">
							<td>ID</td>
							<td>Estado</td>
