...
<html lang="es">  
	...
	<head>
		<title> Inicio de sesión graduandos </title>			
		<meta charset="UTF-8">
						...
						<div class="container">
							<div class="row">
								<div class="col-xs  center-xs">
									<h4>INICIO DE SESIÓN GRADUANDOS</h4>
					...
					<div class="container">
						<div class="row center-xs">
							<div class="articulos col-xs">
								<article>																		
									<form name="formulario" action="../capaIntermedia/login.php?modo=login" method="POST">
										<div class="graduando">
										<label><span class="icon-graduation-cap"></span>GRADUANDOS<span class="icon-graduation-cap"></span></label>	
										</div>									
										...
										<nav class="bt-salir">
											<ul>
												<li><a href="http://localhost/Siageg/capaSuperior/regGrad.php"><span class="color5"><i class="icon icon-save"></i></span>Registrarme</a></li>
											</ul>
										</nav>
