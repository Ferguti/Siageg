...
<html lang="es">  
	...
	<head>
	    ...
	    <link rel="stylesheet" href="../css/regPer.css">	   
...
<div  class="contenedor">	
	...
	<section class="main">
		...
		<!-- incio formulario -->
		<form action="../capaIntermedia/registro.php?modo=personal" name="formulario" method="POST">
		...
		<select name="usuario" id="usuario" title="Tipo de usuario">
			<option>Tipo de usuario</option>
			<option>CDE</option>
			<option>Secretaría</option>
		</select>				

		<input type="password" name="ct" id="ct" placeholder="Clave asignada" maxlength="20" title="clave asignada para el registro de personal">
		...
		<input type="hidden" value="1" name="personal">
...
<script src="../js/regPer.js"></script>
